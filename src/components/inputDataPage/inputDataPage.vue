    ...
    <div class="relative bg-gray-700 h-screen">
        ...
        <div class="my-3">
            ...
            <div class="flex mx-2 rounded border border-gray-400 px-2 py-2 text-white my-1">
                ...
                <div class="w-1/6">
                    <button class="border rounded border-gray-400 p-2" :class="{ 'bg-gray-400': msyValue === 2 }"
                        @click="toggleAvaliable(2, 'MSY')">
                        <CheckIcon class="h-6 w-6 text-green-300" />
                    </button>
                </div>
                <div class="w-1/6">
                    <button class="border rounded border-gray-400 p-2" :class="{ 'bg-gray-400': msyValue === 1 }"
                        @click="toggleAvaliable(1, 'MSY')">
                        <ExclamationTriangleIcon class="h-6 w-6 text-yellow-300" />
                    </button>
                </div>
                <div class="w-1/6">
                    <button class="border rounded border-gray-400 p-2" :class="{ 'bg-gray-400': msyValue === 0 }"
            ...
            <div class="flex mx-2 rounded border border-gray-400 px-2 py-2 text-white my-1">
                ...
                <div class="w-1/6">
                    <button class="border rounded border-gray-400 p-2" :class="{ 'bg-gray-400': gilValue === 2 }"
                        @click="toggleAvaliable(2, 'GIL')">
                        <CheckIcon class="h-6 w-6 text-green-300" />
                    </button>
                </div>
                <div class="w-1/6">
                    <button class="border rounded border-gray-400 p-2" :class="{ 'bg-gray-400': gilValue === 1 }"
                        @click="toggleAvaliable(1, 'GIL')">
                        <ExclamationTriangleIcon class="h-6 w-6 text-yellow-300" />
                    </button>
                </div>
                <div class="w-1/6">
                    <button class="border rounded border-gray-400 p-2" :class="{ 'bg-gray-400': gilValue === 0 }"
            ...
            <div class="flex mx-2 rounded border border-gray-400 px-2 py-2 text-white my-1">
                ...
                <div class="w-1/6">
                    <button class="border rounded border-gray-400 p-2" :class="{ 'bg-gray-400': fuluValue === 2 }"
                        @click="toggleAvaliable(2, 'Fulu')">
                        <CheckIcon class="h-6 w-6 text-green-300" />
                    </button>
                </div>
                <div class="w-1/6">
                    <button class="border rounded border-gray-400 p-2" :class="{ 'bg-gray-400': fuluValue === 1 }"
                        @click="toggleAvaliable(1, 'Fulu')">
                        <ExclamationTriangleIcon class="h-6 w-6 text-yellow-300" />
                    </button>
                </div>
                <div class="w-1/6">
                    <button class="border rounded border-gray-400 p-2" :class="{ 'bg-gray-400': fuluValue === 0 }"
